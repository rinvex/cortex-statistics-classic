...
class PublishCommand extends BasePublishCommand
{
     ...
     * @var string
     */
    protected $signature = 'cortex:publish:statistics {--f|force : Overwrite any existing files.} {--r|resource=all}';
    ...
    public function handle(): void
    {
        ...
        switch ($this->option('resource')) {
            case 'lang':
                ...
                break;
            case 'config':
                $this->call('vendor:publish', ['--tag' => 'cortex/statistics::config', '--force' => $this->option('force')]);
                break;
            case 'migrations':
