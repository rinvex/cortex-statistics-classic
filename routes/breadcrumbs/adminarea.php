...
Breadcrumbs::for('adminarea.cortex.statistics.statistics.index', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('adminarea.cortex.statistics.statistics.agents', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('adminarea.cortex.statistics.statistics.devices', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
    $breadcrumbs->push(trans('cortex/statistics::common.devices'), route('adminarea.cortex.statistics.statistics.devices'));
});

Breadcrumbs::for('adminarea.cortex.statistics.statistics.geoips', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
    $breadcrumbs->push(trans('cortex/statistics::common.geoips'), route('adminarea.cortex.statistics.statistics.geoips'));
});

Breadcrumbs::for('adminarea.cortex.statistics.statistics.paths', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
    $breadcrumbs->push(trans('cortex/statistics::common.paths'), route('adminarea.cortex.statistics.statistics.paths'));
});

Breadcrumbs::for('adminarea.cortex.statistics.statistics.platforms', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
    $breadcrumbs->push(trans('cortex/statistics::common.platforms'), route('adminarea.cortex.statistics.statistics.platforms'));
});

Breadcrumbs::for('adminarea.cortex.statistics.statistics.requests', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
    $breadcrumbs->push(trans('cortex/statistics::common.requests'), route('adminarea.cortex.statistics.statistics.requests'));
});

Breadcrumbs::for('adminarea.cortex.statistics.statistics.routes', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.statistics.statistics.index');
